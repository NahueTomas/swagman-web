...
export const OperationServers = observer(({ isOpen, onClose }: ServerProps) => {
  ...
  const operationSelectedServer = operation.getSelectedServer();

  const currentServer: ServerModel = !!operationSelectedServer
    ? operationSelectedServer
    : spec.getSelectedServer();

  const isOperationSpecific = !!operationSelectedServer;
  ...
  const handleServerChange = (serverUrl: string) => {
    if (operation.getSelectedServer()) operation.setSelectedServer(serverUrl);
    else spec.setSelectedServer(serverUrl);
  };
